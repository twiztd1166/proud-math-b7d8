...
test('internal Drive media opens and can create device-local media progress',async({page})=>{
  ...
  const root=page.locator('#puPlayerRoot');await expect(root.getByRole('dialog',{name:'Training player'})).toBeVisible();await expect(root.locator('#puDrivePlayer')).toBeVisible();
