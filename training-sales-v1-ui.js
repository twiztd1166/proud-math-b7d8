(()=>{
  ...
  const pricingFinanceControl=Object.freeze({
    ...
    implementationPrivacy:'Private vendor email was used only to establish implementation/adoption status. Paradise University does not expose mailbox content, customer records, lender credentials, or portal credentials.',
    unresolved:Object.freeze([
      'Exact live discount authorization / exception workflow beyond current tool and manager-approval controls',
      'Exact current Paradise-approved lender application workflow, program eligibility, required disclosures, and lender-specific terms',
  ...
  const readinessGraduationControl=Object.freeze({
    ...
    unresolved:Object.freeze([
      'Actual current written Sales Rep exam and answer key',
      'Actual current verbal-test script, questions, scoring rubric, and pass calculation',
  ...
  window.PU_SALES_UI_VERSION='2026.08.16-pu-sales-ui-v6';
})();