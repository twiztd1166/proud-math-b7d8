...
function liveDecisionCompareBoard(profiles,open=false){
  ...
  return `<details class="liveCompareBoard" data-live-decision-comparison ${open?'open':''}>
    <summary class="liveCompareHead"><div><span>Live opportunity comparison</span><b>${rows.length} governed targets</b></div><small>Decision · date · current + prior cost + commitment · historical outcome · current + best placement · contact · readiness · hard deadline · timing · direct action</small></summary>
