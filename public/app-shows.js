...
function showCard(s){
  ...
  const boothHint=profile?.best_observed_booth
    ?`Best observed: ${profile.best_observed_booth}${profile.best_observed_booth_year?' ('+profile.best_observed_booth_year+')':''}`
    :(profile?.latest_preserved_booth?`Latest: ${profile.latest_preserved_booth}${profile.latest_preserved_booth_year?' ('+profile.latest_preserved_booth_year+')':''}`:(profile?.has_booth?'Booth history available':''));
