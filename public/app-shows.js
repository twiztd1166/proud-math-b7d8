...
function liveComparisonLogistics(op){
  const status=opportunityLogisticsStatusLabel(op?.current_logistics_status);
  const detail=governedFirstSentence(op?.current_logistics_text,'Logistics detail not recorded.');
