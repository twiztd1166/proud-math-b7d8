...
function catalogFilterSummary(){
  ...
  const labels={
    ...
    com:{HAS:'Has COM',MISSING:'Missing COM'},performance:{HAS:'Has history performance',MISSING:'Missing history performance'},lp:{HAS:'Has LeadPerfection',MISSING:'Missing LeadPerfection'},
  ...
  if(all){
    ...
    body.innerHTML=`<h2>Filter All Shows</h2><div class="subtitle">Counts update against your other selections. Apply combines filters and replaces any Quick View.</div>
      ...
      <div class="filterSection"><div class="filterSectionTitle">Data availability</div><div class="filterGrid">
        ...
        ${filterField('History performance','fPerformance',f.performance,opts([['ANY','Any'],['HAS','Has history performance'],['MISSING','Missing history performance']],{ANY:fc.total,...fc.flags.has_performance}))}
        ${filterField('LeadPerfection','fLp',f.lp,opts([['ANY','Any'],['HAS','Has annual LP source'],['MISSING','Missing annual LP source']],{ANY:fc.total,...fc.flags.has_lp_performance}))}
