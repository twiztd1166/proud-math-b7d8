...
function openDetail(id){
  ...
  const bestBooth=profile?.best_observed_booth?`${profile.best_observed_booth}${profile.best_observed_booth_year?' · '+profile.best_observed_booth_year:''}`:(profile?.latest_preserved_booth?`${profile.latest_preserved_booth}${profile.latest_preserved_booth_year?' · '+profile.latest_preserved_booth_year:''}`:'Not enough preserved booth evidence');
