...
let state={
  ...
  catalogFilters:{
    ...
    comBand:'ALL',lifetimeNetBand:'ALL',outcomeEvidence:'ALL',currentCostBand:'ALL',currentCostStatus:'ALL',currentPlacementStatus:'ALL',currentScheduleStatus:'ALL',currentLogisticsStatus:'ALL',
