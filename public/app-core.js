...
let state={
  ...
  catalogFilters:{
    ...
    comBand:'ALL',lifetimeNetBand:'ALL',currentCostBand:'ALL',
...
const SHOW_CATALOG_FILTER_KEYS=['profileState','historyYear','lpYear','cumulativeLpYear','tier','historyDepth','contact','booth','cost','com','performance','historyPayment','application','lp','cumulativeLp','coi','worked','comBand','lifetimeNetBand','currentCostBand','currentStatus','currentTreatment','confirmation','currentEventYear'];
const SHOW_CURRENT_FILTER_KEYS=['status','treatment','eventYear','timing','confirmation','owner','evidence','payment','costBand','followUp'];
const SHOW_CATALOG_SORTS=['RECOMMENDED','BOOKING_DECISION','CURRENT_FIRST','NEXT_OPPORTUNITY','CURRENT_COST_LOW','CURRENT_COST_HIGH','NAME_ASC','NAME_DESC','LATEST_HISTORY','HISTORY_DEPTH','HISTORY_RECORDS','OCCURRENCES','WORKED_YEARS','LOWEST_COM','HIGHEST_COM','LIFETIME_NET','LIFETIME_SALES','CLOSE_VOLUME','ISSUED','NET_2025','NET_2024','DATA_COMPLETE','MISSING_DATA'];
...
const SHOW_QUICK_VIEWS=['NONE','ALL_LIVE_REBOOK','ALL_ACT_NOW','ALL_ACT_LATER','ALL_QUOTE_REQUIRED','ALL_NO_PRIOR_PLACEMENT','ALL_REBOOK','ALL_REBOOK_PURSUE','ALL_REBOOK_WATCH','ALL_REBOOK_HOLD','ALL_HISTORICAL_2013','ALL_TOP_NET','ALL_LOW_COM','ALL_MISSING','ALL_HIST_ONLY','ALL_LP_SOURCE_ONLY','ALL_CURRENT_LINKED','CURRENT_BOOK_NOW','CURRENT_COMMITTED','CURRENT_WATCH','CURRENT_IN_PLAY','CURRENT_DUE7','CURRENT_EVIDENCE','CURRENT_NO_DATE','CURRENT_COST_HIGH'];
