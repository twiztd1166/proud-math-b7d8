/* Paradise Canvass Manager v3.11 — one-screen field dashboard.
   Controlled legal/source data is unchanged by these presentation-layer clarity fixes. */
...
function fieldHours(r){
  ...
  return FIELD_HOURS_OVERRIDES[String(r?.name||'')]||'Use Paradise’s normal route schedule.';
}
