const CACHE='pcm-field-v3-6-2026-08-14';
const CORE=['./','./index.html','./style.css','./style-v2.css','./pwa-v3.css','./hardening-v3-2.css','./plain-data.js','./provenance-v3-2.js','./core-v2.js','./lookup-v2.js','./browse-v3.js','./release-v2a.js','./history-v2.js','./release-v2b.js','./pwa-v3.js','./field-v36.js','./boot-v2.js','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
